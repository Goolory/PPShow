...
(function ($) {
    ...
    FileInput.prototype = {
        ...
        upload: function () {
            ...
            if (totLen < self.minFileCount-1 && self.minFileCount > 0) {
    ...
    $.fn.fileinput.locales.en = {
        ...
        uploadLabel: '上传',
        uploadTitle: '上传选中文件',
        msgSizeTooLarge: '文件太大啦!', //File "{name}" (<b>{size} KB</b>) exceeds maximum allowed upload size of <b>{maxSize} KB</b>. Please retry your upload
        msgFilesTooLess: '请至少选择 <b>{n}</b>文件上传!',
        msgFilesTooMany: '上传文件太多啦，请上传少于<b>{m}</b>张!',
        msgFileNotFound: '"{name}" 未找到!',
        msgFileSecured: '安全限制防止读取文件 "{name}".',
        msgFileNotReadable: '文件 "{name}" 不可读.',
        msgFilePreviewAborted: '文件预览中止 "{name}".',
        msgFilePreviewError: '读取文件时出错 "{name}".',
        msgInvalidFileType: '文件类型无效 "{name}". 只支持 "{types}" 文件。',
        msgInvalidFileExtension: '文件的无效扩展名 "{name}".',
        msgValidationError: '上传错误',
        msgLoading: 'Loading file {index} of {files} &hellip;',
        msgProgress: 'Loading file {index} of {files} - {name} - {percent}% completed.',
        msgSelected: '选择了{n}张图片',
        msgFoldersNotAllowed: '不能放入文件夹.',
        dropZoneTitle: '可将图片拖拽至此'
    };
